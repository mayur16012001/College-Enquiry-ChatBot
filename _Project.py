...
Developers : Mayur      Rounik Saha        Kunga Topgyal  
...
function for producing response of
    ...
    elif chat == 'bye' or chat == 'goodbye' or chat == 'exit' or chat == 'close' or chat == 'end' or chat == 'Thank you':
          answer = 'Bye'
...
button_front = Button (frame_welcome , image = front , relief = "flat" , bg = c1 , bd = "3px solid white" , command = welcome_to_info ).place(x=470 , y=10)
...
option_1 = Label (frame_topic , text = '1- Annual Day' , font = 'Verdana 15 italic' , bg = c1 , fg= c2)
...
option_2 = Label (frame_topic , text = '2- Sports Day' , font = 'Verdana 15 italic' , bg = c1 , fg= c2)
...
option_3 = Label (frame_topic , text = '3- Cultural Activities ' , font = 'Verdana 15 italic' ,bg = c1 , fg= c2)
...
option_4 = Label (frame_topic , text = '4- College Information   ' , font = 'Verdana 15 italic' , bg = c1 , fg= c2)
